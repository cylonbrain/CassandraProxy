...
class CassandraProxy:
    ...
    def addTopic(self,topic, starttime, endtime):
        ...
        #Da der Tabllenname nur aus 48 zeichen ohne '/' bestehen darf, wird der letze abschnitt des Topics als Tabellen name genutzt
        #tablename = "command_velocity"
        tablename = splittopic[-1]
    ...
    def insertCassandra(self,data, table):
        ...
        object = yaml.load(table.get(str(time))['yaml_object'])
        print object;
    ...
    def createTable(self, name):
        ...
        try :
            ...
            sys.create_column_family(self.keyspace, str(name))
        except :
